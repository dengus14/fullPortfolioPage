  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, flex: 1 }}>
        {/* Apple logo */}
        <svg width="13" height="16" viewBox="0 0 814 1000" fill="#EDEDEF" style={{ flexShrink: 0, marginTop: 1 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
        ...
        <svg width="16" height="13" viewBox="0 0 20 16" fill="none" style={{ marginTop: 1 }}>
          <path d="M10 15L0.5 6.5C3.2 3.8 6.9 2 11 2s7.8 1.8 10.5 4.5L10 15z" fill="#EDEDEF" fillOpacity="0.25" />
          <path d="M10 15L3 8.5C5 6.5 7.3 5.2 10 5.2s5 1.3 7 3.3L10 15z" fill="#EDEDEF" fillOpacity="0.55" />
          <path d="M10 15L6.5 11.5C7.5 10.3 8.7 9.5 10 9.5s2.5.8 3.5 2L10 15z" fill="#EDEDEF" />
          <circle cx="10" cy="14.5" r="1.3" fill="#EDEDEF" />
        </svg>

        {/* Battery */}
        <svg width="24" height="12" viewBox="0 0 24 12" fill="none">
          <rect x="0.5" y="0.5" width="20" height="11" rx="2.5" stroke="#EDEDEF" strokeOpacity="0.35" />
          <rect x="1.5" y="1.5" width="14" height="9" rx="1.5" fill="#EDEDEF" fillOpacity="0.8" />
          <path d="M21.5 4v4c.9-.5 1.5-1.3 1.5-2s-.6-1.5-1.5-2z" fill="#EDEDEF" fillOpacity="0.35" />
        </svg>
